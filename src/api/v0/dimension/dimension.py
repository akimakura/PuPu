...
from src.api.v0.const import DIMENSION_URL, MODEL_NAME_URL
from src.api.v0.dimension.dependencies import get_dimension_service, get_meta_sync_service
...
from src.models.dimension import Dimension, DimensionCreateRequest, DimensionEditRequest, DimensionV0
...
@router.get(
    ...
    response_model=list[DimensionV0],
...
async def get_dimension_list_by_model_name(
    ...
    return [DimensionV0.model_validate(dimension) for dimension in result]
...
async def get_dimension_by_dimension_name(
    ...
    return DimensionV0.model_validate(result)
