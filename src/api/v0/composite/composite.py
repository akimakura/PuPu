...
from src.api.v0.composite.dependencies import get_composite_service
from src.api.v0.const import COMPOSITE_URL, COMPOSITE_URL_WITHOUT_MODEL
...
from src.models.composite import Composite, CompositeCreateRequest, CompositeEditRequest, CompositeV0
...
@router.get(
    ...
    response_model=list[CompositeV0],
...
async def get_composite_by_composite_name(
    ...
    return CompositeV0.model_validate(result)
