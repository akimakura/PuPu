...
from src.api.v1.const import DATASTORAGE_URL, DATASTORAGE_URL_WITHOUT_MODEL
...
@router.get(
    ...
    response_model=list[DataStorageV1],
...
async def get_data_storage_list_by_model_name(
    ...
    return [DataStorageV1.model_validate(data_storage) for data_storage in result]
...
async def get_data_storage_by_ds_name(
    ...
    return DataStorageV1.model_validate(result)
