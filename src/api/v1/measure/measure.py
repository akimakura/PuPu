...
from src.api.v1.const import MEASURE_URL, MEASURE_WITHOUT_MODEL_URL
from src.api.v1.enums import CacheNamespaceEnum
from src.api.v1.measure.dependencies import get_measure_service
...
from src.models.measure import Measure, MeasureCreateRequest, MeasureEditRequest, MeasureV1
...
async def get_measure_list_by_model_name(
    ...
    return [MeasureV1.model_validate(measure) for measure in result]
...
async def get_measure_by_measure_name(
    ...
    return MeasureV1.model_validate(result)
