...
from src.tasks.datastorage import create_datastorage_task, update_datastorage_task
...
@router.post(
    "/tenants/{tenantName}/datastorages/",
...
async def create_datastorage(
    ...
    tasks = [
        ...
        for datastorage_name in datastorages
